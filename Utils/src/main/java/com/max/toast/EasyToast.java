...
public class EasyToast {
     ...
     */
    public static void show(Context context, int msg, int length) {
     ...
     */
    public static void showShortInThread(final Context context, int msg) {
     ...
     * 当你在线程中使用toast时，请使用这个方法
     */
    public static void showShortInThread(Context context, String msg) {
     ...
     */
    public static void showInThread(Context context, int msg,int length) {
     ...
     * 当你在线程中使用toast时，请使用这个方法(可以控制显示多长时间)
     */
    public static void showInThread(final Context context, final String msg, final int length) {
        new Thread() {
            @Override
            public void run() {
                Looper.prepare();//先移除
