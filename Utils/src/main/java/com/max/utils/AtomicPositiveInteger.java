...
public class AtomicPositiveInteger extends Number {
	private static final long serialVersionUID = -8050938505802076854L;
	private final AtomicInteger i;
    private static  AtomicPositiveInteger mInstance ;
    
    public static synchronized AtomicPositiveInteger getInstance(){
    	
    	if (mInstance==null) {
			mInstance = new AtomicPositiveInteger();
		}
    	return mInstance;
    }
